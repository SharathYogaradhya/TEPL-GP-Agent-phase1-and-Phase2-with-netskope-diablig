# Shared Netskope client functions (v14).
...
#   . "C:\PaloAlto Package\Netskope Script\Netskope-Functions-v14.ps1"
#
# Renumbered from v7 to v14 (no functional change) so this file's version
# label matches Phase2 Windows-Final-v14.ps1 and the standalone Netskope
# Disable-and-Uninstall-Windows-Final-v14.ps1 - previously these three
# related files carried different, unsynchronized version numbers (v13 /
# v7 / v7), which was confusing to track together.
#
