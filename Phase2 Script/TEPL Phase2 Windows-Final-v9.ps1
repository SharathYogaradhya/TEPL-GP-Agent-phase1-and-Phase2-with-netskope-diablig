...
# customer. Only used when $netskopeAction is "Uninstall" and tamper
# protection is enabled - applied via the confirmed MSI PASSWORD
# property. Not needed for the default "Disable" action.
