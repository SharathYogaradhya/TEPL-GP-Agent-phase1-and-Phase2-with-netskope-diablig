...
3. Run `Phase1 Script\TEPL Phase1 Windows-Final.ps1` as Administrator.
...
└── Phase1 Script\
    └── TEPL Phase1 Windows-Final.ps1
```

This package is a copy of the customer-validated `Phase1 Script/TEPL Phase1 Windows-Final.ps1` at the repo root — that original file is never modified.
