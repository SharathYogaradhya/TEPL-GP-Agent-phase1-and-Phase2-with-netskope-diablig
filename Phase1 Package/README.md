...
This package carries `Phase1 Script/TEPL Phase1 Windows-Final-v5.ps1` at the repo root — a copy of the customer-validated original with these fixes, all local-machine-state checks (no GlobalProtect network/tunnel connectivity check — that stays in Phase2):
