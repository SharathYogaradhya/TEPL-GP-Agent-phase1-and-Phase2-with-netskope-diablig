...
├── Phase1 Script\
│   └── TEPL Phase1 Windows-Final-v4.ps1   (adds an MSI exit-code check; certs+GP scope unchanged)
├── Phase2 Script\
...
2. Run whichever script matches what you're testing, as Administrator:
   - `Phase1 Script\TEPL Phase1 Windows-Final-v4.ps1` — certs + GlobalProtect only.
