...
# Renumbered from v13 to v14 (no functional change) so this script's
# version label matches Netskope-Functions-v14.ps1 and the standalone
# Netskope Disable-and-Uninstall-Windows-Final-v14.ps1 below - previously
# these three related files carried unsynchronized version numbers
# (v13 / v7 / v7).
#
# Shared Netskope functions (v14): polls for up to 90 seconds after each
...
$netskopeFunctionsPath = "C:\PaloAlto Package\Netskope Script\Netskope-Functions-v14.ps1"
if (-not (Test-Path -Path $netskopeFunctionsPath)) {
    Write-Log "Netskope-Functions-v14.ps1 not found at path: $netskopeFunctionsPath"
    exit 1
}
